 ...
 */
async function getOrCreateStripeConnectAccount(userId) {
 ...
 */
export async function createAccountLink(userId, refreshUrl, returnUrl) {
    try {
...
export async function getAccountStatus(userId) {
    ...
    try {
        ...
        try {
            ...
            console.error(`Warning: Failed to retrieve Stripe account ${user.stripe_connect_account_id}:`, stripeError.message);
 ...
 */
export function registerConnectOnboardingRoutes(router) {
    /**
