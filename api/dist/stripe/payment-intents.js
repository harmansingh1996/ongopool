 ...
 */
export async function capturePaymentIntent(request) {
    try {
        ...
        const capturedPayment = await stripe.paymentIntents.capture(request.payment_intent_id, captureAmount < paymentIntent.amount ? { amount_to_capture: captureAmount } : {});
        return {
            success: true,
 ...
 */
export async function cancelPaymentIntent(request) {
    try {
        if (!request.payment_intent_id) {
            return {
                success: false,
 ...
 */
export async function createRefund(request) {
    try {
        if (!request.payment_intent_id) {
            return {
                success: false,
...
export function registerPaymentIntentRoutes(router) {
    ...
    router.post('/payment-intents/capture', async (req, res) => {
    ...
    router.post('/payment-intents/cancel', async (req, res) => {
