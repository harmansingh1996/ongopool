...
import { refreshUserRatingStats } from '../lib/ratingsService';
...
const RatingModal: React.FC<RatingModalProps> = ({
  ...
  const submitRating = async () => {
    ...
    try {
      ...
      const statsResult = await refreshUserRatingStats(ratedUserId);
      if (!statsResult.success) {
        console.error('Failed to refresh rating stats:', statsResult.error);
      }
